...
{
    public class DrawableSlideTap : DrawableSentakkiHitObject
    {
        public readonly HitReceptor HitArea;
        public readonly SlideStarBody StarPiece;
        ...
        protected override void UpdateInitialTransforms()
        {
            ...
            {
                StarPiece.FadeInFromZero(animTime).ScaleTo(1, animTime);
                ...
                using (BeginDelayedSequence(animTime, true))
                {
                    ...
                    StarPiece.MoveToY((float)(-SentakkiPlayfield.INTERSECTDISTANCE + excessDistance), animTime + HitObject.HitWindows.WindowFor(HitResult.Miss));
        ...
        protected override void UpdateStateTransforms(ArmedState state)
        {
            ...
            switch (state)
            {
                ...
                case ArmedState.Miss:
                    StarPiece.ScaleTo(0.5f, time_fade_miss, Easing.InCubic)
