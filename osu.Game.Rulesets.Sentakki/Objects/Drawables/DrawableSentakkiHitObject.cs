...
public abstract partial class DrawableSentakkiHitObject : DrawableHitObject<SentakkiHitObject>
{
    ...
    private readonly PausableSkinnableSound breakSample;

    protected DrawableSentakkiHitObject(SentakkiHitObject? hitObject = null)
        : base(hitObject!)
    {
        AddRangeInternal([
            scorePaddingObjects = [],
    ...
    protected void LoadBreakSamples()
    {
