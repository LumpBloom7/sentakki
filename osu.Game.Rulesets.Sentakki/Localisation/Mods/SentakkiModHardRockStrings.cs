...
public static class SentakkiModHardRockStrings
{
    ...
    public static LocalisableString JudgementModeDescription =>
        new TranslatableString(getKey(@"judgement_mode_description"), @"Judgement modes determine how strict the hitwindows are during gameplay.");

    public static LocalisableString MinimumResult => new TranslatableString(getKey(@"minimum_result"), @"Minimum hit result");

    public static LocalisableString MinimumResultDescription => new TranslatableString(getKey(@"minimum_result_description"),
        @"The minimum HitResult that is accepted during gameplay. Anything below will be considered a miss.");
