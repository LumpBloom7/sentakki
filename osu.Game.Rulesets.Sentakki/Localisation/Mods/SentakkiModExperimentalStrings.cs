...
namespace osu.Game.Rulesets.Sentakki.Localisation.Mods
{
    public static class SentakkiModExperimentalStrings
    {
        ...
        public static LocalisableString ModDescription => new TranslatableString(getKey(@"mod_description"), @"Some experimental features to be added to future sentakki builds. Autoplay/No-Fail recommended. Replays unsupported.");
        ...
        public static LocalisableString TwinSlidesDescription => new TranslatableString(getKey(@"twin_slides_description"), @"Allow more than one Slide-body to share the same time and origin (Requires multitouch)");
